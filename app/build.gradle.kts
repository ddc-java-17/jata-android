...
android {
    ...
    defaultConfig {
        ...
        resValue("string", "log_level",
                (project.property("logLevel") as String).uppercase())
...
roomDdl {
    source.set(project.file("$projectDir/schemas/edu.cnm.deepdive.jata.service.JataDatabase/1.json"))
